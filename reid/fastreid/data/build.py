...
def build_reid_test_loader(cfg, dataset_name, mapper=None, **kwargs):
    ...
    return test_loader, len(dataset.query), test_items

def build_reid_test_loader2(cfg, dataset_name, path_dataset, mapper=None, **kwargs):


    cfg = cfg.clone()
    #print("path_dataset: ",path_dataset)
    #print("dataset_name: ",dataset_name)
    dataset = DATASET_REGISTRY.get(dataset_name)(root=path_dataset, **kwargs)
    if comm.is_main_process():
        dataset.show_test()
    test_items = dataset.query + dataset.gallery
    #print("dataset.query=",dataset.query)
    #print("dataset.gallery=",dataset.gallery)
